...
def load_data(urls, sw_path=None, min_frequency=0, max_length=0, language='en', vocab_processor=None,
              shuffle=True):
    ...
    if vocab_processor is None:
        vocab_processor = tf.learn.preprocessing.VocabularyProcessor(max_length, min_frequency=min_frequency)
